...
<head>
    ...
    <script type="text/javascript">
        function deleteItems() {
            //提交form
            document.itemsForm.action = "${pageContext.request.contextPath }/batchDeleteItems.action";
    ...
    <table width="100%" border=1>
        ...
        <c:forEach items="${itemsList }" var="item">
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath }/goUpdate.action?id=${item.id}">修改</a></td>
